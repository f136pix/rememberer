  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: "absolute left-1 bg-blue-300",
        nav_button_next: "absolute right-1 bg-blue-300",
        ...
        day_today: "bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50 p-6",
        day_outside:
